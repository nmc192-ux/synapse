...
class EventType(str, Enum):
    ...
    RUN_DISPATCH_RECONCILED = "run.dispatch.reconciled"
    WORKER_UNAVAILABLE = "worker.unavailable"
    WORKER_REQUEST_RUNNING = "worker.request.running"
    WORKER_REQUEST_SLOW = "worker.request.slow"
    WORKER_REQUEST_STUCK = "worker.request.stuck"
    WORKER_REQUEST_RECOVERED = "worker.request.recovered"
    WORKER_RESULT_REPLAYED = "worker.result.replayed"
    WORKER_OWNERSHIP_STALE = "worker.ownership.stale"
